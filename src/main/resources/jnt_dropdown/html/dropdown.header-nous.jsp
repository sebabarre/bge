...
<div id="qui-sommes-nous" class="dropdown">
  <a href="/sites/bge/accueil/qui-sommes-nous.html" style="text-decoration:none;height:100%;display:block;position:relative;">${currentNode.properties['name'].string}
